...
const AdminDashBoard = () => {
    ...
    const adminRightSide = () => {
        ...
        <div className="card mb-4">
            ...
            <ul className="list-group">
                <li className="list-group-item">
                    <span className="bagde badge-pill badge-dark mr-2">Name</span> {name}
                </li>
                <li className="list-group-item">
                    <span className="bagde badge-pill badge-dark mr-2">email</span> {email}
                </li>
                <li className="list-group-item">
                    <span className="bagde badge-pill badge-danger mr-2">Admin Area</span> 
                </li>
            </ul>
        </div>
        )
